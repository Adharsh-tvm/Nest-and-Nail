      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative">
        <div className="w-full max-w-md flex flex-col items-center">
          ...
          <div className="w-full text-center space-y-2 mb-8">
            <h2 className="text-3xl font-black text-[#0f291e]">Welcome Back</h2>
          ...
          <div className="mt-8 text-center text-sm font-medium">
            <p className="text-gray-500">
              ...
              <a href="/signup" className="text-[#0f291e] hover:text-[#1B4332] font-bold hover:underline transition-all">
                Sign up here
              </a>
            </p>
          </div>
