...
//           <FileText
//             className={`mb-2 ${type === "certificate" ? "text-red-500" : "text-gray-400"
//               }`}
//             size={32}
//           />
...
//       {/* Type Badge */}
//       <div
//         className={`absolute top-2 right-2 p-1 rounded-md text-[10px] font-bold uppercase ${type === "certificate"
...
//   // Sync tempSkills when user loads or edits start
//   React.useEffect(() => {
...
//     try {
//       const response = await userApi.updateSkills(currentUser.id, tempSkills);
//       setUser({ ...currentUser, skills: tempSkills });
...
//                 className={`px-4 py-2 rounded-full font-bold text-xs transition-colors border flex items-center gap-2 ${isAvailable
//                     ? "bg-green-500 text-white border-green-600"
//                     : "bg-gray-800/50 text-gray-300 border-gray-700 backdrop-blur-md"
//                   }`}
//               >
//                 <div
//                   className={`w-2 h-2 rounded-full ${isAvailable ? "bg-white animate-pulse" : "bg-gray-400"
//                     }`}
//                 ></div>
...
//                   }
//                 }}
//                 className={`mb-2 px-4 py-2 border font-medium rounded-lg shadow-sm text-sm flex items-center gap-2 transition-colors ${isEditing
//                     ? "bg-[#1B4332] text-white border-[#1B4332] hover:bg-[#143326]"
...
//                 {(isEditing ? tempSkills : currentUser.skills && currentUser.skills.length > 0 ? currentUser.skills : []).length > 0 ? (
//                   (isEditing ? tempSkills : currentUser.skills!).map((skill, i) => (
//                     <span
//                       key={i}
//                       className={`px-3 py-1 rounded-lg text-xs font-semibold border flex items-center gap-2 ${isEditing
//                           ? "bg-white border-gray-300 text-gray-700 pr-2"
...
//                     className="flex-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#1B4332] focus:ring-1 focus:ring-[#1B4332]"
//                   />
//                   <button
//                     onClick={handleAddSkill}
//                     disabled={!newSkill.trim()}
//                     className="px-3 py-2 bg-[#1B4332] text-white rounded-lg hover:bg-[#143326] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
//                   >
//                     <Plus size={16} />
//                   </button>
//                 </div>
