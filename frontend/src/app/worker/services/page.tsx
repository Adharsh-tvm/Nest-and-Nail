    ...
    <div className="w-full max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <p className="text-slate-500 mt-2 text-sm font-medium">View and manage all your assigned services</p>
        </motion.div>
      ...
      {loading ? (
        ...
        >
          ...
          <p className="text-slate-500 mt-1 max-w-sm text-center">There are no services matching the current filter criteria.</p>
          {activeTab !== "ALL" && (
            <button 
