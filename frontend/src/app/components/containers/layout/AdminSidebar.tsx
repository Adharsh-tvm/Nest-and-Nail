    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full">
          {/* Logo Section */}
          <div
            className={`h-24 flex items-center mb-2 transition-all duration-300 ${
          ...
          <div className="flex-1 overflow-y-auto py-2 px-4 space-y-8 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <div>
              <h3
                className={`text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 px-2 ${
                  !isOpen && "lg:hidden"
                }`}
              >
                Menu
              ...
              <nav className="space-y-1">
                {navItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`group relative flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 cursor-pointer overflow-hidden ${
                          isActive
            ...
            <div>
              ...
              <nav className="space-y-1">
                ...
                <button
                  ...
                  className={`w-full group flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-red-50 text-gray-500 hover:text-red-600 transition-all duration-300 cursor-pointer mt-4 ${
                    !isOpen ? "lg:justify-center lg:px-0" : ""
                  }`}
                >
